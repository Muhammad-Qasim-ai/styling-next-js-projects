...
export default function About() {
  return (
    <>
      <div id="projects" className="  opacity-0 mb-52"></div>
      <div   className="  flex justify-center h-1/3 2md:mb-96 items-center ">
        <div className=" 2md:max-w-6xl flex flex-col justify-center w-screen 2md:mx-0  mx-9  items-center">
          ...
          <div className="flex flex-wrap justify-around w-11/12">
            <div className="w-80 h-72  shadow-xl rounded-md p-5 bg-light-navy cursor-pointer hover:-translate-y-1 duration-100 my-3">
